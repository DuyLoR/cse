...
namespace CSE_website.Controllers
{
    public class PermissionsController : Controller
    {
        ...
        public PermissionsController(CSEWebsiteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Permissions != null ? 
                          ...
                          Problem("Entity set 'CSEWebsiteContext.Permissions'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CSEWebsiteContext.Permissions'  is null.");
            }
            var permission = await _context.Permissions.FindAsync(id);
            if (permission != null)
            {
