(function ($) {
    ...
    // Input Select Research
    var inputResearch = document.querySelector(".input-research");
    var tagifyResearch = new Tagify(inputResearch, {
        whitelist: ["tag1", "tag2", "tag3", "tag4"],
        dropdown: {
            enabled: 0,
            closeOnSelect: false,
        },
        ...
        callbacks: {
            onInput: function (e) {
                tagifyResearch.dropdown.show.call(tagifyResearch, e.detail.value);
            },
            onBlur: function (e) {
                setTimeout(() => {
                    tagifyResearch.dropdown.hide.call(tagifyResearch);
                }, 200);
            },
        },
    });
    ...
    var tagifySubjects = new Tagify(inputSubjects, {
        whitelist: ["tag1", "tag2", "tag3", "tag4"],
        dropdown: {
            enabled: 0,
            closeOnSelect: false,
        ...
        callbacks: {
            onInput: function (e) {
                tagifySubjects.dropdown.show.call(tagifySubjects, e.detail.value);
            },
            onBlur: function (e) {
                setTimeout(() => {
                    tagifySubjects.dropdown.hide.call(tagifySubjects);
                }, 200);
            },
        },
    });
